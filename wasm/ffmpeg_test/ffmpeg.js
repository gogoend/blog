...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ffmpeg')) {
        Object.defineProperty(Module['ready'], '_ffmpeg', { configurable: true, get: function() { abort('You are getting _ffmpeg on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ffmpeg', { configurable: true, set: function() { abort('You are setting _ffmpeg on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 14166240,
    DYNAMIC_BASE = 19409120,
    DYNAMICTOP_PTR = 14166080;
...
// STATICTOP = STATIC_BASE + 14165216;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=14166096;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 14166144, 4), 14166144);function _gmtime_r(time, tmPtr) {
...
Module['_ff_h264_cabac_tables'] = 1519525;
